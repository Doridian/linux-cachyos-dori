...
_dori_add_source=(
    'git+https://github.com/amkillam/ryzen_smu.git#commit=1be4fb1cd9d60b5ddefc2a4201a898766a731400'
    'git+https://github.com/jetm/mediatek-mt7927-dkms.git#commit=ad1f3e4d19fe540aaa1f449ddba86c65db9bfc82'
)
_dori_add_b2sums=(
    'SKIP'
    'SKIP'
